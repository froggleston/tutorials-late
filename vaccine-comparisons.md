...
1          baseline    61007495.98
2   vaccinate 0.001    51085633.17
3    vaccinate 0.01       53112.19
```
...
contact.age.group    [0,15)  [15,65)  [65,Inf)
         [0,15)   6.8461538 1.684993 0.5677992
         [15,65)  5.9555175 9.169207 3.9064037
         [65,Inf) 0.5902511 1.148941 1.7142857
```
...
``` output
  intervention_type cumulative_sum
1          baseline       61007496
2   vaccinate 0.001       51085633
3 vaccinate group 1       58204314
4 vaccinate group 2       48207534
5 vaccinate group 3       58006857
```
